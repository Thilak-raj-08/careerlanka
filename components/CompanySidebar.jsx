...
const menuItems = [
  { name: 'Dashboard', href: '/company/dashboard', icon: RiDashboardLine },
  { name: 'Company Profile', href: '/company/profile', icon: RiBuilding2Line },
  { name: 'Post New Job', href: '/company/post-job', icon: RiAddCircleLine, highlight: true },
  { name: 'Manage Jobs', href: '/company/jobs', icon: RiBriefcaseLine },
  { name: 'Applications', href: '/company/applications', icon: RiFileTextLine },
]
    ...
    <aside className="hidden lg:flex fixed top-16 left-0 bottom-0 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex-col">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-brand-500 to-brand-700 flex items-center justify-center text-white font-bold shadow-md">
                ...
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${
                    isActive
                      ...
                      : item.highlight
                      ? 'text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20 border border-dashed border-brand-300 dark:border-brand-700'
